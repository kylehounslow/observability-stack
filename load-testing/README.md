...
opensearch-benchmark execute-test \
  ...
  --workload=pmc \
  --client-options="use_ssl:true,verify_certs:false,basic_auth_user:admin,basic_auth_password:My_password_123!@#" \
  --redline-test
```
...
└── k6/
    ├── scenarios/
    │   ├── api-queries.js     # API-level PPL, search, PromQL
